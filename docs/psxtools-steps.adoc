...
....
php  psxtools/quadfile_prediv.php  TEXTURE.0.PNG  [TEXTURE.1.PNG]...  .PREDIV.QUAD
....
...
REMOVED as 2025-10-14::
	Updated Quad Player to auto-detect and convert srcquad from 1.0 to px. This step is optional now.
'''
