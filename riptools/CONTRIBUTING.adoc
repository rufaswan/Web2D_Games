...
* export everything in SRC in a texture atlas, with a text file th note down the correct blending forumula to use.
...
Using QUAD file, the original SRC is preserved. It will know it is rendering a straight line because SRC is a straight line.
