...
//////////////////////////////
function get_mainhtml( array &$html ) : string
{
...
function epub_file( array &$list, array &$meta, string $base ) : void
{
	$MAIN = [
...
function load_file( array &$list, string $dir ) : array
{
	global $gp_mime;
	$t = [
		'html'  => [],
	...
	while ( $cnt > 0 )
	{
		...
		if ( $ext === 'html' )
			...
			$t['file'][] = [$list[$cnt]['name'] , $gp_mime[$ext]];
	} // while ( $cnt > 0 )
...
function dir2epub( string $dir ) : void
{
	if ( ! is_dir($dir) )
		return;
