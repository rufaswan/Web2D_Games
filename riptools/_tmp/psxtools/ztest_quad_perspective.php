...
///// MATRIX TEST /////
	...
	$m = [5,0,0,0 , 0,0,3,0 , 0,1,3,0 , 1,0,0,1];
		matrix_dump($m, 'M4');
	$minv = matrix_inv4($m);
...
function perspective_quad( &$srcquad, &$dstquad )
{
	...
	//     SRC = M_INV * DST
	$src = [
		[$srcquad[0] , $srcquad[1] , 1],
		[$srcquad[2] , $srcquad[3] , 1],
		[$srcquad[4] , $srcquad[5] , 1],
		[$srcquad[6] , $srcquad[7] , 1],
	];
	$dst = [
		[$dstquad[0] , $dstquad[1] , 1],
		[$dstquad[2] , $dstquad[3] , 1],
		[$dstquad[4] , $dstquad[5] , 1],
		[$dstquad[6] , $dstquad[7] , 1],
	];
...
$src = [10,100 , 100,100 , 100,10 , 10,10];
$dst = [-100,-100 , 50,-50 , 100,100 , -50,50];
