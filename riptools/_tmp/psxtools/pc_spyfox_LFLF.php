...
//////////////////////////////
function sect_awiz( &$file, $dir, $pal=[] )
{
	echo "== sect_awiz()\n";
...
function sect_mult( &$file, $dir, $pal=[] )
{
	echo "== sect_mult()\n";
	$rgbs = sect_rippal($file);
	if ( empty($rgbs) )  $rgbs = $pal;
...
function sect_akos( &$akos, $dir, $pal=[] )
{
	echo "== sect_akos()\n";
	$rgbs = sect_rippal($file);
	if ( empty($rgbs) )  $rgbs = $pal;
...
function sect_obim( &$obim, $dir, $pal=[] )
{
	echo "== sect_obim()\n";
	if ( empty($pal) )
		return;
