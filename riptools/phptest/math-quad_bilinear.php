...
function bilinear( string $name, array $dst, int $nx, int $ny ) : void
{
	echo "\n$name\n";
...
$dst = [52,0 , 228,46 , 255,229 , 0,246];
bilinear('top-left 0,0', $dst, $nx, $ny);

// center = 133,130
$dst = [-81,-130 , 95,-84 , 122,99 , -133,116];
bilinear('center 0,0', $dst, $nx, $ny);

$dst = [95,-84 , -81,-130 , -133,116 , 122,99];
bilinear('hflip', $dst, $nx, $ny);

$dst = [-133,116 , 122,99 , 95,-84 , -81,-130];
bilinear('vflip', $dst, $nx, $ny);

$dst = [95,-84 , -81,-130 , 122,99 , -133,116];
bilinear('twist top', $dst, $nx, $ny);

$dst = [-81,-130 , 122,99 , 95,-84 , -133,116];
